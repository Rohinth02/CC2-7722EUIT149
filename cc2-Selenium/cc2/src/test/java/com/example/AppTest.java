...
public class AppTest {
    ...
    public void testCase1() throws IOException, InterruptedException, NullPointerException {
        ...
        ExtentSparkReporter eReporter = new ExtentSparkReporter("C:\\Users\\ROHINTH\\cc2-Selenium\\cc2\\src\\report\\ExtentReport.html");
        ...
        Thread.sleep(5000);
        WebElement name = driver.findElement(By.xpath("//*[@id=\"searchGrid\"]/div/section[1]/section[1]/div/div[1]/div[1]/h1"));
                String source = name.getText();
